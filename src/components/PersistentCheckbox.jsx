...
export function PersistentCheckbox({ label, defaultChecked }) {
  ...
  return (
    <input
      ...
      aria-label={label}
      className="h-4 w-4 shrink-0 cursor-pointer rounded border-zinc-300 accent-brand focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-2 dark:border-zinc-600"
    />
  )
}
