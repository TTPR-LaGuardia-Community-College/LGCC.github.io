...
## 🛠️ Module 1 — Program Setup, Git & GitHub {{ anchor: false }}
...
## 🏗️ Module 2 — HTML Foundations {{ anchor: false }}
...
## 🎨 Module 3 — CSS Foundations {{ anchor: false }}
...
## ⚡ Module 4 — JavaScript Fundamentals {{ anchor: false }}
...
## 🌐 Module 5 — DOM Manipulation {{ anchor: false }}
...
## 🔌 Module 6 — External API Requests {{ anchor: false }}
...
## ⚛️ Module 7 — Introduction to React {{ anchor: false }}
...
## 🔄 Module 8 — React State & Props {{ anchor: false }}
...
## 🧭 Module 9 — React Router {{ anchor: false }}
...
## 🚀 Module 10 — Node.js & Express {{ anchor: false }}
...
## 🗄️ Module 11 — PostgreSQL & Sequelize {{ anchor: false }}
...
## 🔗 Module 12 — Full-Stack CRUD App {{ anchor: false }}
...
## 📦 Module 13 — Deployment {{ anchor: false }}
...
## 🎓 Module 14 — Capstone Project {{ anchor: false }}
